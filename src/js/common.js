(function () {
    ...
    function createChart(container, locale, format) {
        ...
        series.stroke(seriesStrokeFunction('#3C8AD8', '3 5 10 5'));
        seriesConfiguration(series, 'Delivery Failure');

        // setup third series
        series = chart.line(seriesData_3);
        series.stroke(seriesStrokeFunction('#F18126', '3 5'));
        ...
        chart.xAxis().labels().textFormatter(function () {
            return anychart.format.dateTime(this.value, format, -8 * 60, locale);
        });
